...
"https://4.bp.blogspot.com/-yAExPAr7JeA/WDaBRVuJwxI/AAAAAAALb7I/Dbvda0KD5uECF3_SBjsvkl2_mqP9_BweQCLcB/s1600/AS000834_17.gif",
  ...
  var callback = () => api.sendMessage({body:`梁Luật Box梁
  NỘI QUY S21༻
Vào group nhớ tt tốt nha mn ^^ 
-Thành viên ko phân biệt độ tuổi 
X-Trẩu với toxic cút hộ=)
-có mồm xin zo thì có mồm xin ra uot nhóm ko lý do bị tui phốt á =))
tv nhớ thân thiện hạn chế gây war với các tv
-Hạn chế sử dụng các icon (😏,🤡,🌚,🥵,🤤)
-ko bơ thành viên với boss v qtv 
-Quản trị viên 1 : 1 tháng tuyển đc trên 30tv =160robux 
Quản trị viên 2 : 1 tháng tuyển trên 25tv =80robux 
(Có làm mới có ăn nha=)) ko làm mà cuối tháng đòi tao là chetme nha)
Hạn chế chửi lộn zứ
Cuối tuần mn nhớ onl đều để gl game ^^
 mấy câu tục tĩu thiếu Văn minh 
share link 18+ and ba cái xàm loz 
Tao kick hết 

----S21----`,attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg")); 
